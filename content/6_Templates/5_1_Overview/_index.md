...
1. **[existing_vpc_resources](../5_2_existing_vpc_resources/)** (Deploy First): Creates supporting infrastructure including management VPC, Transit Gateway, spoke VPCs, and deployment mode configuration
2. **[autoscale_template](../5_3_autoscale_template/)** (Choose One): Deploys FortiGate AutoScale group with Gateway Load Balancer for elastic scaling
3. **[ha_pair](../5_4_ha_pair/)** (Choose One): Deploys FortiGate Active-Passive HA Pair with FGCP for fixed-capacity deployment
