...
- [existing_vpc_resources Template](../3_1_existing_vpc_resources/) - Required prerequisite
- [autoscale_template](../3_2_autoscale_template/) - Alternative deployment mode
- [Licensing Options](../../3_example_templates/3_2_autoscale_template/Autoscale_Reference/4_4_Licensing_Options/) - BYOL, PAYG, FortiFlex guidance
- [Solution Components](../../3_example_templates/3_2_autoscale_template/Autoscale_Reference/) - Deep dive into architecture
...
**Next Steps:**
1. Deploy [existing_vpc_resources](../3_1_existing_vpc_resources/) with HA Pair mode
