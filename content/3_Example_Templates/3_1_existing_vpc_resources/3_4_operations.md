...
Deploy [autoscale_template](../3_2_autoscale_template/) to create the FortiGate autoscale group with Gateway Load Balancer:
...
- [autoscale_template Deployment Guide](../3_2_autoscale_template/)
- [FortiManager Integration Configuration](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_5_fortimanager_integration/)
- [Licensing Options](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_4_Licensing_Options/)

### For HA Pair Deployment

Deploy [ha_pair template](../3_3_ha_pair/) to create the FortiGate Active-Passive HA Pair:
...
**Recommended next reading**:
- [ha_pair Template Deployment Guide](../3_3_ha_pair/)
- [FGCP HA Configuration](../../3_example_templates/3_2_autoscale_template/autoscale_reference/)
- [Licensing Options](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_4_Licensing_Options/)
