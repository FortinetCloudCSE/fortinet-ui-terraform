...
- Use when planning to deploy [autoscale_template](../3_2_autoscale_template/)
...
- Use when planning to deploy [ha_pair template](../3_3_ha_pair/)
...
**When to use**: Choose AutoScale mode when deploying [autoscale_template](../3_2_autoscale_template/) for elastic scaling with Gateway Load Balancer.
...
**When to use**: Choose HA Pair mode when deploying [ha_pair template](../3_3_ha_pair/) for fixed-capacity Active-Passive deployment with FGCP.
...
- **[Configuration Scenarios](3_1_existing_vpc_resources/)** - Common deployment patterns and use cases
- **[Step-by-Step Deployment](3_3_manual_deployment/)** - Complete deployment guide with examples
- **[Operations & Troubleshooting](3_4_operations/)** - Post-deployment configuration, troubleshooting, and cleanup procedures
