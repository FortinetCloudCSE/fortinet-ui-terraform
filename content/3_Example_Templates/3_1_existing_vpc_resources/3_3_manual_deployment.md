...
menuTitle: "Manual Deployment Guide"
weight: 44
---
...
<!-- TODO: Add deployment-mode-selection.png screenshot -->

#### Option A: AutoScale Deployment

**Choose this if** you plan to deploy [autoscale_template](../3_2_autoscale_template/) for elastic scaling:
...
**Choose this if** you plan to deploy [ha_pair template](../3_3_ha_pair/) for fixed Active-Passive deployment:
