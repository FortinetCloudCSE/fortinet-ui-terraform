...
See [Firewall Architecture](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_2_firewall_architecture/) for detailed comparison.
...
See [Internet Egress](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_1_internet_egress/) for detailed comparison.
...
See [Management Isolation](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_3_management_isolation/) for options and recommendations.
...
See [FortiFlex Setup Guide](Autoscale_Reference/4_4_Licensing_Options/) for complete configuration details.
...
See [Licensing Options](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_4_licensing_options/) for detailed comparison and cost analysis.
...
See [Autoscale Group Capacity](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_6_autoscale_group_capacity/) for detailed planning.
...
See [FortiManager Integration](../../3_example_templates/3_2_autoscale_template/autoscale_reference/4_5_fortimanager_integration/) for complete details.
{{% /notice %}}
...
See [FortiManager Integration Configuration](Autoscale_Reference/4_5_FortiManager_Integration/) for advanced options including UMS mode.
